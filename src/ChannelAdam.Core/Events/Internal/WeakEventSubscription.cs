...
namespace ChannelAdam.Events.Internal
{
    ...
    public delegate void UnsubscribeFromEventAction<TEventArgs>(EventHandler<TEventArgs> eventHandler) where TEventArgs : EventArgs;
        ...
        where TEventArgs : EventArgs
    {
        ...
        private WeakReference weakReferenceToEventHandlerTarget;
        private UnboundDelegateEventHandler unboundDelegateEventHandler;
        ...
        /// <seealso cref="http://msdn.microsoft.com/en-us/library/ms177195(v=vs.100).aspx" />.
        /// </remarks>
